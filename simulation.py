...
class TrafficAgent:
    ...
    def get_state(self):
        ...
        """
        return self.last_action or "initial"
    ...
    def step(self):
        ...
        # Log actions and emissions for later processing
        self.model.episode_summary["total_emissions"] += self.calculate_co2_emissions()
